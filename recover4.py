...
best_content = ""
# We can just extract all JSON blocks
blocks = text.split('\n')
for block in blocks:
    ...
    try:
        ...
        if 'content' in data:
            ...
            if 'file:///e:/Work/Code/Web/Gold/src/main.ts' in content and 'The following code has been modified to include a line number' in content:
