...
new_2 = r'''document.getElementById('target-val')!.innerHTML = ${gameManager.targetScore} <span style="font-size:0.65em; opacity:0.85; font-weight:normal">(需赚: {gameManager.currentLevelDelta})</span>;'''
